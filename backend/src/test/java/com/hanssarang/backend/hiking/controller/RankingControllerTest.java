...
public class RankingControllerTest extends ApiDocument {
    ...
    private ResultActions 랭킹내_사용자_검색_요청(String nickname) throws Exception {
        return mockMvc.perform(get("/api/v1/rankings/1?nickname=" + nickname)
                .header(AUTHORIZATION, BEARER + ACCESS_TOKEN));
    }

    private void 랭킹내_사용자_검색_성공(ResultActions resultActions, RankingSearchResponse rankingSearchResponse) throws Exception {
        resultActions.andExpect(status().isOk())

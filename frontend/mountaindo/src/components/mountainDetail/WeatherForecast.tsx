...
function WeatherForecast() {
  ...
  const getShortlyWeather = async () => {
    try {
      const url = `http://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getVilageFcst?serviceKey=${API_KEY}&numOfRows=1500&pageNo=1&base_date=20220922&base_time=0500&nx=55&ny=127&dataType=JSON`;
  ...
  const getWeeklyWeather = async () => {
    try {
      const url = `http://apis.data.go.kr/1360000/MidFcstInfoService/getMidLandFcst?serviceKey=${API_KEY}&numOfRows=10&pageNo=1&regId=11B00000&tmFc=202209220600&dataType=JSON`;
      const response = await axios.get(url);
      let data: any = JSON.stringify(response);
  ...
  const getWeeklyTemp = async () => {
    try {
      const url = `http://apis.data.go.kr/1360000/MidFcstInfoService/getMidTa?serviceKey=${API_KEY}&numOfRows=10&pageNo=1&regId=11B00000&tmFc=202209220600&dataType=JSON`;
      const response = await axios.get(url);
      let data: any = JSON.stringify(response);
      let item: any = JSON.parse(data).data.response.body.items.item[0];

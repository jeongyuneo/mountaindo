...
function AgreementModal2({
  setVisibleModal2,
  visibleModal2,
  singleCheck,
  isSelected2,
}: Props) {
  useEffect(() => {}, [isSelected2]);
  return (
        ...
        <ScrollView style={styles.scrollView}>
          <Pressable
            ...
            <View>
              ...
              <AppText style={styles.contentText}>
                개인정보를 제공받는 자 : <AppTextBold>MountainDo</AppTextBold>
              </AppText>
              <AppText style={styles.contentText}>
              ...
              <AppText style={styles.contentText}>1. 파기절차</AppText>
              <AppText style={styles.contentText}>
                MountainDo은(는) 파기 사유가 발생한 개인정보를 선정하고,{' '}
                MountainDo의 개인정보 보호책임자의 승인을 받아 개인정보를
                파기합니다.
              </AppText>
              <AppText style={styles.contentText}>2. 파기방법</AppText>
              <AppText style={styles.contentText}>

          ...
          <Pressable
            ...
            <View>
              <View style={styles.titleWrapper}>
                ...
                <Text style={styles.titleText}>위치기반 서비스 전문</Text>
              </View>
              <Text style={styles.subtitleText}>제1장 총칙</Text>
              <Text style={styles.subtitleText}>제 1조 (목적)</Text>
              ...
              <Text style={styles.subtitleText}>제 3 조 (관계법령의 적용)</Text>
              <Text style={styles.contentText}>
                회사는 직접 위치정보를 수집하거나 위치정보사업자로부터
                위치정보를 전달받아 아래와 같은 위치기반서비스를 제공합니다.
              </Text>
              <Text style={styles.subtitleText}>제 4 조 (서비스의 내용)</Text>
              <Text style={styles.contentText}>
              ...
              <Text style={styles.subtitleText}>제 9 조 (면책)</Text>
              <Text style={styles.contentText}>
